          ...
          <v-col md="5" class="ml-16">
            <div>
              <v-col>
                    ...
                    <v-row class="mb-6" no-gutters>
                      ...
                      <v-col>
                        ...
                        <v-card-subtitle class="pt-0 pb-0"
                          ><h4>Costes de envío: 4,95 €</h4>
                        </v-card-subtitle>
                        <v-card-subtitle class="pt-0 pb-0"
                          ><h4>Plazo estimado: 48 / 72 horas</h4>
                        </v-card-subtitle>
                      </v-col>
                    </v-row>
                  </v-card>
                ...
                <div >
                  <h2 class="pl-11 mt-2">Total pedido: 75,35 €</h2>
                </div>
              </v-col>
            </div>
          </v-col>
      ...
      <div class="d-flex justify-center mx-16 mt-6 pb-16">
        <v-row class="mb-6" no-gutters>
          <v-col md="5" class="ml-16">
            <div>
              <v-col>
                <h1 class="grey--text text--lighten-1">Cesta</h1>
                <div v-for="(p, i) in cesta" :key="i">
                  <v-card
                    class="rounded-lg"
                    style="
                ...
                <v-divider color="grey"></v-divider>
                <div >
                  <h2 class="pl-11 mt-2 grey--text text--lighten-1">Total pedido: 75,35 €</h2>
                </div>
              </v-col>
            </div>
          </v-col>
